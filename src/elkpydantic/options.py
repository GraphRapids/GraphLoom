...
class _LayoutOptionsBase(BaseModel):
    ...
    def serialize_node_size_constraints(self, v: Optional[Union[str, List[NodeSizeConstraint]]], _info):
        if v is None:
            return None
        return _serialize_enum_list(v)
    ...
    @classmethod
    def parse_node_size_constraints(cls, v: Union[str, List[NodeSizeConstraint], NodeSizeConstraint]):
        return _parse_enum_set(v, NodeSizeConstraint, allow_single_str=True)

    @field_serializer("org_eclipse_elk_nodeSize_options", check_fields=False)
    def serialize_node_size_options(self, v: Optional[Union[str, List[NodeSizeOption]]], _info):
        if v is None:
            return None
        return _serialize_enum_list(v)
    ...
    @classmethod
    def parse_node_size_options(cls, v: Union[str, List[NodeSizeOption], NodeSizeOption]):
        return _parse_enum_set(v, NodeSizeOption, allow_single_str=True)

    @field_serializer("org_eclipse_elk_contentAlignment", check_fields=False)
    def serialize_content_alignment(self, v: Optional[List[str]], _info):
        if v is None:
            return None
        return _serialize_enum_list(v)
    ...
    @classmethod
    def parse_content_alignment(cls, v: Union[str, List[str]]):
...
class ParentLayoutOptions(_LayoutOptionsBase):
    ...
    org_eclipse_elk_radial_wedgeCriteria: Optional[str] = Field(default=None, alias="org.eclipse.elk.radial.wedgeCriteria")
    org_eclipse_elk_aspectRatio: Optional[float] = Field(default=None, alias="org.eclipse.elk.aspectRatio")
    org_eclipse_elk_layered_nodePlacement_bk_edgeStraightening: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.nodePlacement.bk.edgeStraightening")
    org_eclipse_elk_layered_nodePlacement_bk_fixedAlignment: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.nodePlacement.bk.fixedAlignment")
    org_eclipse_elk_box_packingMode: Optional[str] = Field(default=None, alias="org.eclipse.elk.box.packingMode")
    ...
    org_eclipse_elk_radial_compactor: Optional[str] = Field(default=None, alias="org.eclipse.elk.radial.compactor")
    ...
    org_eclipse_elk_compaction_compactionStrategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.compaction.compactionStrategy")
    org_eclipse_elk_rectpacking_packing_strategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.rectpacking.packing.strategy")
    ...
    org_eclipse_elk_disco_componentCompaction_strategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.disco.componentCompaction.strategy")
    ...
    org_eclipse_elk_layered_considerModelOrder_strategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.considerModelOrder.strategy")
    org_eclipse_elk_layered_considerModelOrder_components: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.considerModelOrder.components")
    ...
    org_eclipse_elk_contentAlignment: Optional[List[str]] = Field(default=None, alias="org.eclipse.elk.contentAlignment")
    ...
    org_eclipse_elk_processingOrder_spanningTreeCostFunction: Optional[str] = Field(default=None, alias="org.eclipse.elk.processingOrder.spanningTreeCostFunction")
    ...
    org_eclipse_elk_layered_considerModelOrder_groupModelOrder_cmGroupOrderStrategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.considerModelOrder.groupModelOrder.cmGroupOrderStrategy")
    org_eclipse_elk_layered_crossingMinimization_strategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.crossingMinimization.strategy")
    ...
    org_eclipse_elk_layered_wrapping_cutting_strategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.wrapping.cutting.strategy")
    org_eclipse_elk_layered_considerModelOrder_groupModelOrder_cbGroupOrderStrategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.considerModelOrder.groupModelOrder.cbGroupOrderStrategy")
    ...
    org_eclipse_elk_layered_cycleBreaking_strategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.cycleBreaking.strategy")
    ...
    org_eclipse_elk_layered_directionCongruency: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.directionCongruency")
    org_eclipse_elk_graphviz_neatoModel: Optional[str] = Field(default=None, alias="org.eclipse.elk.graphviz.neatoModel")
    ...
    org_eclipse_elk_layered_edgeLabels_centerLabelPlacementStrategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.edgeLabels.centerLabelPlacementStrategy")
    org_eclipse_elk_json_edgeCoords: Optional[str] = Field(default=None, alias="org.eclipse.elk.json.edgeCoords")
    ...
    org_eclipse_elk_layered_edgeLabels_sideSelection: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.edgeLabels.sideSelection")
    ...
    org_eclipse_elk_force_model: Optional[str] = Field(default=None, alias="org.eclipse.elk.force.model")
    ...
    org_eclipse_elk_layered_wrapping_strategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.wrapping.strategy")
    ...
    org_eclipse_elk_layered_crossingMinimization_greedySwitch_type: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.crossingMinimization.greedySwitch.type")
    org_eclipse_elk_layered_crossingMinimization_greedySwitchHierarchical_type: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.crossingMinimization.greedySwitchHierarchical.type")
    ...
    org_eclipse_elk_hierarchyHandling: Optional[str] = Field(default=None, alias="org.eclipse.elk.hierarchyHandling")
    ...
    org_eclipse_elk_layered_interactiveReferencePoint: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.interactiveReferencePoint")
    ...
    org_eclipse_elk_layered_layerUnzipping_strategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.layerUnzipping.strategy")
    ...
    org_eclipse_elk_stress_dimension: Optional[str] = Field(default=None, alias="org.eclipse.elk.stress.dimension")
    ...
    org_eclipse_elk_layered_considerModelOrder_longEdgeStrategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.considerModelOrder.longEdgeStrategy")
    ...
    org_eclipse_elk_topdownpacking_nodeArrangement_strategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.topdownpacking.nodeArrangement.strategy")
    org_eclipse_elk_layered_nodePlacement_networkSimplex_nodeFlexibility_default: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.nodePlacement.networkSimplex.nodeFlexibility.default")
    ...
    org_eclipse_elk_layered_nodePlacement_strategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.nodePlacement.strategy")
    org_eclipse_elk_layered_layering_nodePromotion_strategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.layering.nodePromotion.strategy")
    ...
    org_eclipse_elk_rectpacking_widthApproximation_optimizationGoal: Optional[str] = Field(default=None, alias="org.eclipse.elk.rectpacking.widthApproximation.optimizationGoal")
    ...
    org_eclipse_elk_graphviz_overlapMode: Optional[str] = Field(default=None, alias="org.eclipse.elk.graphviz.overlapMode")
    ...
    org_eclipse_elk_polyomino_highLevelSort: Optional[str] = Field(default=None, alias="org.eclipse.elk.polyomino.highLevelSort")
    org_eclipse_elk_polyomino_lowLevelSort: Optional[str] = Field(default=None, alias="org.eclipse.elk.polyomino.lowLevelSort")
    org_eclipse_elk_polyomino_traversalStrategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.polyomino.traversalStrategy")
    ...
    org_eclipse_elk_layered_portSortingStrategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.portSortingStrategy")
    ...
    org_eclipse_elk_layered_compaction_postCompaction_constraints: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.compaction.postCompaction.constraints")
    org_eclipse_elk_layered_compaction_postCompaction_strategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.compaction.postCompaction.strategy")
    ...
    org_eclipse_elk_processingOrder_rootSelection: Optional[str] = Field(default=None, alias="org.eclipse.elk.processingOrder.rootSelection")
    ...
    org_eclipse_elk_mrtree_searchOrder: Optional[str] = Field(default=None, alias="org.eclipse.elk.mrtree.searchOrder")
    ...
    org_eclipse_elk_json_shapeCoords: Optional[str] = Field(default=None, alias="org.eclipse.elk.json.shapeCoords")
    ...
    org_eclipse_elk_radial_sorter: Optional[str] = Field(default=None, alias="org.eclipse.elk.radial.sorter")
    ...
    org_eclipse_elk_layered_edgeRouting_splines_mode: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.edgeRouting.splines.mode")
    org_eclipse_elk_stress_epsilon: Optional[float] = Field(default=None, alias="org.eclipse.elk.stress.epsilon")
    org_eclipse_elk_structure_structureExtractionStrategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.structure.structureExtractionStrategy")
    ...
    org_eclipse_elk_radial_optimizationCriteria: Optional[str] = Field(default=None, alias="org.eclipse.elk.radial.optimizationCriteria")
    org_eclipse_elk_processingOrder_treeConstruction: Optional[str] = Field(default=None, alias="org.eclipse.elk.processingOrder.treeConstruction")
    ...
    org_eclipse_elk_layered_wrapping_validify_strategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.wrapping.validify.strategy")
    ...
    org_eclipse_elk_mrtree_weighting: Optional[str] = Field(default=None, alias="org.eclipse.elk.mrtree.weighting")
    ...
    org_eclipse_elk_rectpacking_whiteSpaceElimination_strategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.rectpacking.whiteSpaceElimination.strategy")
    org_eclipse_elk_topdownpacking_whitespaceElimination_strategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.topdownpacking.whitespaceElimination.strategy")
    org_eclipse_elk_rectpacking_widthApproximation_strategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.rectpacking.widthApproximation.strategy")
...
class NodeLayoutOptions(_LayoutOptionsBase):
    ...
    org_eclipse_elk_alignment: Optional[str] = Field(default=None, alias="org.eclipse.elk.alignment")
    ...
    org_eclipse_elk_vertiflex_layoutStrategy: Optional[str] = Field(default=None, alias="org.eclipse.elk.vertiflex.layoutStrategy")
    ...
    org_eclipse_elk_layered_layering_layerConstraint: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.layering.layerConstraint")
    ...
    org_eclipse_elk_layered_nodePlacement_networkSimplex_nodeFlexibility: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.nodePlacement.networkSimplex.nodeFlexibility")
    ...
    org_eclipse_elk_nodeSize_constraints: Optional[Union[str, List[NodeSizeConstraint]]] = Field(default=None, alias="org.eclipse.elk.nodeSize.constraints")
    org_eclipse_elk_nodeSize_minimum: Optional[Any] = Field(default=None, alias="org.eclipse.elk.nodeSize.minimum")
    org_eclipse_elk_nodeSize_options: Optional[Union[str, List[NodeSizeOption]]] = Field(default=None, alias="org.eclipse.elk.nodeSize.options")
    org_eclipse_elk_radial_orderId: Optional[int] = Field(default=None, alias="org.eclipse.elk.radial.orderId")
    org_eclipse_elk_padding: Optional[Any] = Field(default=None, alias="org.eclipse.elk.padding")
    org_eclipse_elk_portAlignment_default: Optional[str] = Field(default=None, alias="org.eclipse.elk.portAlignment.default")
    org_eclipse_elk_portAlignment_east: Optional[str] = Field(default=None, alias="org.eclipse.elk.portAlignment.east")
    org_eclipse_elk_portAlignment_north: Optional[str] = Field(default=None, alias="org.eclipse.elk.portAlignment.north")
    org_eclipse_elk_portAlignment_south: Optional[str] = Field(default=None, alias="org.eclipse.elk.portAlignment.south")
    org_eclipse_elk_portAlignment_west: Optional[str] = Field(default=None, alias="org.eclipse.elk.portAlignment.west")
    org_eclipse_elk_portConstraints: Optional[PortConstraint] = Field(default=None, alias="org.eclipse.elk.portConstraints")
    ...
    org_eclipse_elk_layered_edgeRouting_selfLoopDistribution: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.edgeRouting.selfLoopDistribution")
    org_eclipse_elk_layered_edgeRouting_selfLoopOrdering: Optional[str] = Field(default=None, alias="org.eclipse.elk.layered.edgeRouting.selfLoopOrdering")
    org_eclipse_elk_topdown_hierarchicalNodeAspectRatio: Optional[float] = Field(default=None, alias="org.eclipse.elk.topdown.hierarchicalNodeAspectRatio")
    org_eclipse_elk_topdown_hierarchicalNodeWidth: Optional[float] = Field(default=None, alias="org.eclipse.elk.topdown.hierarchicalNodeWidth")
    org_eclipse_elk_topdown_nodeType: Optional[str] = Field(default=None, alias="org.eclipse.elk.topdown.nodeType")
